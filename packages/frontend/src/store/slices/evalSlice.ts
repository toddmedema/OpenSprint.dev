...
export type FetchFeedbackArg = string;

export const fetchFeedback = createAsyncThunk<FeedbackItem[], FetchFeedbackArg>(
  "eval/fetchFeedback",
  async (projectId) => api.feedback.list(projectId)
);
