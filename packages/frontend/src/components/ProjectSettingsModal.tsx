                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-theme-text mb-2">
                          Max Concurrent Coders: <span className="font-bold">{settings?.maxConcurrentCoders ?? 1}</span>
                        </label>
                        <input
                          type="range"
                          min={1}
                      ...
                      {(settings?.maxConcurrentCoders ?? 1) > 1 && (
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setSettings((s) =>
                                s ? { ...s, unknownScopeStrategy: e.target.value as UnknownScopeStrategy } : null
                              )
                            }
