  ...
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3.98 8.22C3.06 9.31 2.35 10.6 1.93 12C3.23 16.34 7.24 19.5 12 19.5c.99 0 1.95-.14 2.86-.4M6.23 6.23C7.88 5.14 9.87 4.5 12 4.5c4.76 0 8.77 3.16 10.07 7.5-.72 2.39-2.26 4.43-4.3 5.77M6.23 6.23L3 3M6.23 6.23l3.65 3.65M17.77 17.77L21 21M17.77 17.77l-3.65-3.65M14.12 14.12a3 3 0 11-4.24-4.24M14.12 14.12L9.88 9.88"
      />
    </svg>
  );
}
