...
export function AgentsStep({
  ...
  const usesClaudeCli = planningAgent.type === "claude-cli" || codingAgent.type === "claude-cli";
          ...
          {maxConcurrentCoders > 1 && (
            <div>
              ...
              <p className="text-xs text-theme-muted mb-2">
                When file scope can&apos;t be predicted for a task, should the scheduler serialize
                it or run it in parallel?
              </p>
              <select
                className="input"
