          ...
          <form onSubmit={handleCreateFolder} className="px-5 pb-2">
            <div className="flex gap-2 items-center">
              <input
                ...
                autoFocus
              />
              <button type="submit" className="btn-primary text-sm px-3 whitespace-nowrap" disabled={creating || !newFolderName.trim()}>
            ...
            {createError && (
              <p className="text-sm text-theme-error-text mt-1.5">{createError}</p>
            )}
          </form>
        )}
