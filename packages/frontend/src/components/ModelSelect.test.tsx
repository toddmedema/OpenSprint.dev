...
describe("ModelSelect", () => {
  ...
  it("renders custom provider as text input", () => {
    render(
      <ModelSelect provider="custom" value={null} onChange={() => {}} />
    );
  ...
  it("shows loading state for claude provider", () => {
    ...
    render(
      <ModelSelect provider="claude" value={null} onChange={() => {}} />
    );
  ...
  it("renders model options and calls onChange when selection changes", async () => {
    ...
    render(
      <ModelSelect provider="claude" value={null} onChange={onChange} />
    );
  ...
  it("shows No models available when list is empty", async () => {
    mockModelsList.mockResolvedValue([]);
    render(
      <ModelSelect provider="cursor" value={null} onChange={() => {}} />
    );
