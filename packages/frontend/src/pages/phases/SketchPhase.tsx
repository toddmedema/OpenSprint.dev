        ...
        <div className="w-full max-w-2xl">
          ...
          >
            ...
            <textarea
              ...
              disabled={sending}
              rows={4}
              className="w-full rounded-2xl border-0 py-5 px-6 text-lg text-theme-input-text bg-theme-input-bg shadow-lg ring-1 ring-inset ring-theme-ring placeholder:text-theme-input-placeholder focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-brand-500 resize-none transition-shadow hover:shadow-xl disabled:opacity-60"
            />
