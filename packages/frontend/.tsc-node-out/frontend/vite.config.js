...
import { buildSpaContentSecurityPolicyProduction, buildSpaContentSecurityPolicyViteDevelopment, } from "../shared/src/spa-content-security-policy.js";
...
export default defineConfig({
    ...
    server: {
        port: 5173,
        headers: {
            "Content-Security-Policy": buildSpaContentSecurityPolicyViteDevelopment(),
        },
        proxy: {
            "/api": {
