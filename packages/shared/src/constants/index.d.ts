...
export declare const TECHNICAL_BLOCK_REASONS: readonly ["Merge Failure", "Quality Gate Failure", "Coding Failure"];
...
export declare const PLAN_STATUS_ORDER: Record<"planning" | "building" | "in_review" | "complete", number>;
...
export declare const AGENT_NAMES: readonly ["Frodo", "Samwise", "Meriadoc", "Peregrin", "Bilbo", "Rosie", "Lobelia", "Lotho", "Drogo", "Otho", "Ted", "Robin", "Will"];
