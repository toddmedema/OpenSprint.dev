...
export type KanbanColumn = "planning" | "backlog" | "ready" | "in_progress" | "in_review" | "done" | "blocked" | "waiting_to_merge";
...
export declare function complexityToDisplay(complexity: number | undefined): "Simple" | "Complex" | null;
