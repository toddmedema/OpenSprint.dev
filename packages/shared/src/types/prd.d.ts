...
export type PrdSectionKey = "executive_summary" | "problem_statement" | "user_personas" | "goals_and_metrics" | "feature_list" | "technical_architecture" | "data_model" | "api_contracts" | "non_functional_requirements" | "open_questions";
