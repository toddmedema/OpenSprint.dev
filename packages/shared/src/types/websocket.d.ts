...
export interface ExecuteStatusEvent {
    ...
    pendingFeedbackCategorizations?: Array<{
        feedbackId: string;
        category?: string;
    }>;
...
export type ServerEvent = TaskUpdatedEvent | TaskCreatedEvent | TaskClosedEvent | AgentOutputEvent | AgentOutputBackfillEvent | AgentStartedEvent | AgentCompletedEvent | AgentActivityEvent | PrdUpdatedEvent | ExecuteStatusEvent | TaskBlockedEvent | DeliverStartedEvent | DeliverCompletedEvent | DeliverOutputEvent | HilRequestEvent | FeedbackMappedEvent | FeedbackUpdatedEvent | FeedbackResolvedEvent | NotificationAddedEvent | NotificationResolvedEvent | PlanUpdatedEvent | PlanGeneratedEvent | PlanAgentOutputEvent | PlanAgentOutputBackfillEvent;
...
export type ClientEvent = AgentSubscribeEvent | AgentUnsubscribeEvent | PlanAgentSubscribeEvent | PlanAgentUnsubscribeEvent | HilRespondEvent;
