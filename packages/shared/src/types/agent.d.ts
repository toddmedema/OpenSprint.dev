...
export type AgentRole = "dreamer" | "planner" | "harmonizer" | "analyst" | "summarizer" | "auditor" | "coder" | "reviewer" | "merger";
...
export declare function sortAgentsByCanonicalOrder<T>(list: T[], getAgent?: (item: T) => {
    role?: AgentRole;
    phase?: string;
}): T[];
/**
...
export type AgentSessionStatus = "success" | "failed" | "timeout" | "cancelled" | "approved" | "rejected";
