...
export type TaskExecutionOutcome = "running" | "suspended" | "failed" | "rejected" | "requeued" | "demoted" | "blocked" | "completed";
export interface TaskLastExecutionSummary {
    at: string;
    attempt: number;
    outcome: Extract<TaskExecutionOutcome, "failed" | "rejected" | "requeued" | "demoted" | "blocked">;
