...
export declare function getDeploymentTargetConfig(config: DeploymentConfig, targetName: string): DeploymentTargetConfig | undefined;
 ...
 */
export declare function getTargetsForDeployEvent(config: DeploymentConfig, event: DeployEvent): string[];
/**
 ...
 */
export declare function getDeploymentTargetsForUi(config: DeploymentConfig): DeploymentTargetConfig[];
...
export type ReviewAngle = "security" | "performance" | "test_coverage" | "code_quality" | "design_ux_accessibility";
 ...
 */
export declare function maskApiKeysForResponse(apiKeys: ApiKeys | undefined): MaskedApiKeys | undefined;
 ...
 */
export declare function getAgentForPlanningRole(settings: ProjectSettings, role: PlanningRole, planComplexity?: PlanComplexity): AgentConfig;
/**
 ...
 */
export declare function getAgentForComplexity(settings: ProjectSettings, complexity: PlanComplexity | undefined): AgentConfig;
...
export declare function parseTeamMembers(raw: unknown): Array<{
    id: string;
    name: string;
}> | undefined;
/**
 ...
 */
export declare function mergeApiKeysWithCurrent(incoming: unknown, current: ApiKeys | undefined): ApiKeys | undefined;
/**
 ...
 */
export declare function getProviderForAgentType(agentType: AgentConfig["type"]): ApiKeyProvider | null;
/**
