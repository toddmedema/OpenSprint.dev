...
const feedbackRouteTaskStoreMod = await import("../services/task-store.service.js");
const feedbackRoutePostgresOk = (feedbackRouteTaskStoreMod as { _postgresAvailable?: boolean })._postgresAvailable ?? false;
