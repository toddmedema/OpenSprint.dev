...
Install dependencies, clone the repo, and start the dev server. Pick your OS:
...
All of these are installed as part of the [Quick Start](#quick-start) scripts above.
