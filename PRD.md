...
| Agent CLI           | Pluggable (Claude, Cursor, OpenAI, Custom)     | Executes development tasks: code generation, testing, debugging                                                                                                                                                                                                                                                                                                                                                                                      |
...
- Options: Claude (select model: e.g., Sonnet, Opus), Cursor (select model from available options), OpenAI (select model: e.g., GPT-4o), or Custom (user provides CLI command).
- When Claude, Cursor, or OpenAI is selected, OpenSprint queries the provider's API for available models and populates a model dropdown.
